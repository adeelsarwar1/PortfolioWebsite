    ...
    <section id="home" className="min-h-screen flex items-center justify-center relative gradient-bg">
      <div className="container-custom text-center relative z-10">
        ...
        >
          ...
          >
            Hi, I'm <span className="text-gradient">Muhammad Adeel</span>
          </motion.h1>
          ...
          >
            MERN Stack Developer specializing in building exceptional digital experiences
            with modern web technologies and machine learning integration
          </motion.p>
